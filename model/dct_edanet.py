...
class EDANet(nn.Module):
    def __init__(self, num_classes=20):
        ...
        # DownsamplerBlock1
        # self.layers.append(DownsamplingBlock(3, 15))

        # DownsamplerBlock2
        # self.layers.append(DownsamplingBlock(15, 60))
        ...
        # DownsamplerBlock3
        # self.layers.append(DownsamplingBlock(260, 130))
...
if __name__ == "__main__":
    ...
    input = torch.rand(4, 3, 512, 1024).cuda()
    model = EDANet(num_classes=5).cuda()
    model.eval()
    print(model)
    output = model(input)
